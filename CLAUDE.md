...
This project is indexed by GitNexus as **docx-pipeline** (1219 symbols, 2173 relationships, 92 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
