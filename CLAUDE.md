...
This project is indexed by GitNexus as **docx-pipeline** (1020 symbols, 1782 relationships, 69 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/docx-pipeline/context` | Codebase overview, check index freshness |
| `gitnexus://repo/docx-pipeline/clusters` | All functional areas |
| `gitnexus://repo/docx-pipeline/processes` | All execution flows |
| `gitnexus://repo/docx-pipeline/process/{name}` | Step-by-step execution trace |
