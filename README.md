...
> Markdown（左）→ DOCX 输出（右）· 更多截图见 [_screenshots/](_screenshots/)

| 学术论文模板 · Academic | 技术报告模板 · Report |
|:---:|:---:|
| Markdown 源码 → [![Academic Markdown](_screenshots/screenshot_academic_markdown.png)](_screenshots/screenshot_academic_markdown.png) | Markdown 源码 → [![Report Markdown](_screenshots/screenshot_report_markdown.png)](_screenshots/screenshot_report_markdown.png) |
| DOCX 输出 → [![Academic DOCX](_screenshots/screenshot_academic_docx.png)](_screenshots/screenshot_academic_docx.png) | DOCX 输出 → [![Report DOCX](_screenshots/screenshot_report_docx.png)](_screenshots/screenshot_report_docx.png) |
