...
> Markdown（左）→ DOCX 輸出（右）· 更多截圖見 [_screenshots/](_screenshots/)

| 學術論文範本 · Academic | 技術報告範本 · Report |
|:---:|:---:|
| Markdown 原始碼 → [![Academic Markdown](_screenshots/screenshot_academic_markdown.png)](_screenshots/screenshot_academic_markdown.png) | Markdown 原始碼 → [![Report Markdown](_screenshots/screenshot_report_markdown.png)](_screenshots/screenshot_report_markdown.png) |
| DOCX 輸出 → [![Academic DOCX](_screenshots/screenshot_academic_docx.png)](_screenshots/screenshot_academic_docx.png) | DOCX 輸出 → [![Report DOCX](_screenshots/screenshot_report_docx.png)](_screenshots/screenshot_report_docx.png) |
